...
// Douyin trending - v6 NEW PATH to bypass Turbopack cache
...
export async function GET() {
  console.log('[TEST-V2] /api/v2/douyin called - new route loaded!')
  ...
  try {
    ...
    console.log("[TEST-V2] Douyin enrichment done, sample:", JSON.stringify({
      title: items[0]?.title,
    ...
    console.error("[TEST-V2] Douyin error:", error)
